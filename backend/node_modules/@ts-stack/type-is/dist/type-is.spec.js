...
describe('typeOfRequest(headers, types)', function () {
    ...
    it('should not match invalid type', function () {
        ...
        expect(typeIs(headers, [undefined, null, true, function () { }])).toBe(false);
    });
...
describe('is(mediaType, types)', function () {
    ...
    it('should not match invalid type', function () {
        ...
        expect(is('text/html', [undefined, null, true, function () { }])).toBe(false);
    });
...
describe('normalize(type)', function () {
    it('should return false for non-strings', function () {
        ...
        expect(normalize([])).toBe(false);
        expect(normalize(42)).toBe(false);
        expect(normalize(null)).toBe(false);
        expect(normalize(function () { })).toBe(false);
    });
...
//# sourceMappingURL=type-is.spec.js.map