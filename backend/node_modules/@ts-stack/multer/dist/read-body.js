...
function collectFields(busboy, limits) {
    return new Promise((resolve, reject) => {
        ...
        busboy.on('field', (fieldname, value, fieldnameTruncated, valueTruncated) => {
            ...
            if (valueTruncated)
                return reject(new MulterError('LIMIT_FIELD_VALUE', fieldname));
...
function collectFiles(busboy, limits, limitGuard) {
    return new Promise((resolve, reject) => {
        const result = [];
...
export async function readBody(req, headers, limits, limitGuard) {
    const busboy = new Busboy({ headers: headers, limits });
